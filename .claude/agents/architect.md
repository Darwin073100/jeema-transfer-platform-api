...
## Contexto del Proyecto: JEEMA Transfer
- **Arquitectura**: Clean Architecture con Nest.js
- **Patrón**: Cliente Servidor con API REST 
- **Base de datos**: PostgreSQL con TypeORM
- **Frontend**: Nest.js con TypeScript
...
- Backend: [cambios en modelos, modulos nest, class-validator, api rest]
